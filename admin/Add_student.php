...
<div class="row">
      ...
      <div class="col-75">
        <input type="text" id="studentname" name="sname" placeholder=" Enter Student Name" required pattern="[A-Za-z]+" />
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="number" id="studentcourse" name="scourse" placeholder="Enter Class" required />
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="studentphone" name="sphone" placeholder="Enter Mobile-no" required pattern="[6-9][0-9]{9}" title="Please enter valid 10 digit number"/>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="studentparent" name="sparent" placeholder="Enter Parent-name" required pattern="[A-Za-z]+"/>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="parentemail" name="sparentemail" placeholder="Enter Parent's Email-id" required pattern="[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)+" />
      </div>
    </div>
