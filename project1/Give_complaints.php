...
<form method="post" action="_Give_complaints.php">
<div class="container1">
<h2 class="heading"><b>Complaint Box</b></h2>
<div class="container">
 ...
 <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="sname" name="name" placeholder="Enter Student Name" required />
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="srno" name="rollno" placeholder="Enter Roll No" required />
      </div>
    </div>

    <div class="row">
      <div class="col-25">
        <label for="sfb">Complaint : </label>
      </div>
      <div class="col-75">
        <input type="text" id="sfb" name="suggestion" placeholder="Enter Complaint" required />
      </div>
    </div>
