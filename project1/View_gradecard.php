...
<?php
$q = "SELECT s.hgrade as hgrade,s.agrade as agrade,c.cname as cname FROM student_grades s,course_table c WHERE s.sid = '$sid' and s.course_id=c.id ";
$result = mysqli_query($con,$q);
