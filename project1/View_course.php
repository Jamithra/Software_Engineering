...
<div class="classadmin"><b><h3>Course details</h3></b></div>
...
$q = "SELECT  c.id as id, c.cname as cname,t.tname as tname, c.csemester as csemester FROM course_table c, teacher_table t where c.cteacher=t.id";
...
<td><?php echo "$sno"; ?></td>
    ...
    <td><?php echo "$q"; ?></td>
     ...
     <?php echo' <td><a href="Edit_course.php?course_id='.$sno.'"><button type="button" class="btn btn-primary">Edit details</button></a></td>';
?>   
</tr>
